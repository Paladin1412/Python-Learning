 ...
 *
 * @author fanwenli
 * @path("/discovery_banner_ads/")
 */
class Discoverybannerads
{
    ...
    public function getList() {
		...
		$discovery_banner_ads_tmp = array();
		foreach($new_ads as $ad) {
		    $discovery_banner_ads_tmp[$ad['ad_pos']] = $ad;
		}
		
		//sort array by key
		ksort($discovery_banner_ads_tmp);
		
		//set array with key by 0
		$i = 0;
		$discovery_banner_ads = array();
		foreach($discovery_banner_ads_tmp as $ad) {
		    $ad['ad_pos'] = $i;
		    $discovery_banner_ads[$i] = $ad;
		    $i++;
		}
		
        return $discovery_banner_ads;
    }
