...
class AdCellRecommendNoti
{
    ...
    private $strAdCellRecommendNotiCachePre;
    ...
    */
    public function getAdCellRecommend($strVersion, $notiVersion = 0, $intMsgVer = 0, $strPlatform = '')
    {
        //get redis obj
        ...
        $data = NotiCells::getNoti($this->objBase, $redis, $this->strAdCellRecommendNotiCachePre, $this->intCacheExpired, $strV4HttpRoot, $strPlatform, $strVersionName, $notiVersion, $intMsgVer);
