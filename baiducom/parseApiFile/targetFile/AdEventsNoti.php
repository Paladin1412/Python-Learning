...
class AdEventsNoti
{
    ...
    private $strAdEventsNotiCachePre;
    ...
    */
    public function getAdEvents($strVersion, $notiVersion = 0, $intMsgVer = 0, $strPlatform = '')
    {
        //get redis obj
        ...
        $data = NotiEvents::getNoti($this->objBase, $redis, $this->strAdEventsNotiCachePre, $this->intCacheExpired, $strPlatform, $strVersionName, $notiVersion, $intMsgVer);
