...
class SurfaceStatsCollector(object):
  ...
  """
    ...
    def _StorePerfResults(self):
        ...
        print(refresh_period,timestamps)
            ...
            try:
                ...
                if refresh_period is None or timestamps is None:
                    ...
                    if last_timestamp:
                        ...
                        break
                    raise Exception('Unable to get surface finger latency data')
    ...
    """
        ...
        c = subprocess.check_output(
            'adb shell dumpsys SurfaceFlinger --latency com.xiaodianshi.tv.yst/com.xiaodianshi.tv.yst.ui.bangumi.BangumiDetailActivity',
            shell=True)
        ...
        refresh_period = float(results[0]) / nanoseconds_per_second
